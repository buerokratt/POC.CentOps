...
Contains the setting for the Admin Api Key.  Current deployments generate a random complex key which is held in Azure Key Vault and piped into CentOps via configuration.
